//
//  CaseElastic2PageViewController.swift
//  MBNA
//
...
protocol CE2PageViewControllerDelegate: class {
...
class CaseElastic2PageViewController: UIPageViewController {
    weak var apDelegate: CE2PageViewControllerDelegate?
    ...
    fileprivate func notifyDelegateOfNewIndex(didUpdate: Bool = true) {
        if let firstViewController = viewControllers?.first,
            let index = orderedViewControllers.index(of: firstViewController)
        {
...
extension CaseElastic2PageViewController: UIPageViewControllerDataSource {
...
extension CaseElastic2PageViewController: UIPageViewControllerDelegate {
    func pageViewController(_ pageViewController: UIPageViewController,
